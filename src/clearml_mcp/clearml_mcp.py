...
async def get_task_parameters(task_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Failed to get task parameters: {str(e)}"}
...
async def get_task_metrics(task_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Failed to get task metrics: {str(e)}"}
...
async def get_task_artifacts(task_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Failed to get task artifacts: {str(e)}"}
...
@mcp.tool()
async def list_models(project_name: Optional[str] = None) -> List[Dict[str, Any]]:
...
async def get_model_artifacts(task_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Failed to get model artifacts: {str(e)}"}
...
async def get_project_stats(project_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Failed to get project stats: {str(e)}"}


@mcp.tool()
async def compare_tasks(task_ids: List[str], metrics: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"error": f"Failed to compare tasks: {str(e)}"}


@mcp.tool()
async def search_tasks(query: str, project_name: Optional[str] = None) -> List[Dict[str, Any]]:
